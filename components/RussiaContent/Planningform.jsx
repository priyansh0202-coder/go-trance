      ...
      <div className="mx-auto ">
        ...
        >
          ...
          <input
            ...
            placeholder="Name *"
            className="w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-[#1E90FF] outline-none"
            required
          />
          {/* Last Name */}
          ...
          <div className="flex">
            <select
              ...
              onChange={handleChange}
              className="p-2 border border-gray-600 rounded-l-md focus:ring-2 focus:ring-[#1E90FF] outline-none w-24"
            >
            ...
            <input
              ...
              className="w-full p-2 border border-gray-600 rounded-r-md focus:ring-2 focus:ring-[#1E90FF] outline-none"
              required
            />
          </div>
          {/* City */}
